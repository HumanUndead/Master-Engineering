    ...
    return (
        <div className='relative h-dvh w-screen overflow-hidden bg-cover bg-center '
            ...
            <div className='font-extralight	 z-50 absolute top-0 left-0 w-full h-full flex justify-center items-center flex-col text-center'>
                ...
                <span className={`max-sm:text-[20px] md:text-[50px] ${bgGold} bg-clip-text text-transparent mb-2`}> صمم معنا منزل أحلامك
                </span>
                ...
                <div className='max-sm:mt-10 md:mt-5'>
                    <Button Icon={MdOutlineKeyboardArrowLeft} textColor='text-white' text='تواصل معنا' backgroundColor={`${bgGold}`} />
                </div>
            </div>
            ...
            <div className='absolute bottom-20 -right-20 md:-right-22 bg-[#15253E] p-2 md:p-4 -rotate-90'>
                <div dir='rtl' className='flex items-center justify-between gap-4'>
                    <span className={`${bgGold} bg-clip-text text-transparent text-[16px]`}> نبذة عنا </span>
